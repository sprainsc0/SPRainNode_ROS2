...
# on sprain_msgs package to generate the IDL msgs to the dds_fastrpts dir.
...
message(STATUS "sprain_msgs message dir under ${MSGS_DIR}")
...
list(APPEND MICRORTPS_AGENT_FILES ${MICRORTPS_AGENT_DIR}/transform_imu.h)
list(APPEND MICRORTPS_AGENT_FILES ${MICRORTPS_AGENT_DIR}/transform_imu.cpp)
...
get_filename_component(sprain_msgs_FASTRTPSGEN_INCLUDE "../../" ABSOLUTE BASE_DIR ${sprain_msgs_DIR})
add_custom_command(
  ...
  COMMAND
    ...
    --fastrtpsgen-include ${sprain_msgs_FASTRTPSGEN_INCLUDE}
